...
import { PostCreateContextLink } from './PostCreateContextLink';
import { PostCreateContextOther } from './PostCreateContextOther';


export function PostCreateContext() {
    // Context Options Toggle
    const contextOptions = [<PostCreateContextText />, <PostCreateContextPhoto />, <PostCreateContextLink />, <PostCreateContextOther />];
    ...
    return (
        <>
            <div className="flex justify-center gap-4 border-b-2 border-gray-300 pt-10 pb-6">
                <button className={`border-2 border-primary rounded-lg w-30 h-8 text-xs text-white font-semibold bg-primary drop-shadow`}>Hulp Nodig</button>
                <button className={`border-2 border-gray-400 rounded-lg w-30 h-8 text-xs text-gray-400 font-medium bg-white`}>Hulp Aanbieden</button>
            </div>

            <div className="flex justify-center gap-4 py-6">
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(0)} className={`border-2 rounded-full p-3 ${optionsIndex === 0 ? "border-primary bg-primary drop-shadow" : "border-gray-400 bg-white"}`}>
                        <svg className={`${optionsIndex === 0 ? "fill-white" : "fill-gray-400"}`} width="22" height="22" viewBox="0 0 32 32"><g>
                    ...
                    <span className={`pt-1 text-xs ${optionsIndex === 0 ? "text-primary font-semibold" : "text-gray-400 font-normal"}`}>Text</span>
                </div>

                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(1)} className={`border-2 rounded-full p-3 ${optionsIndex === 1 ? "border-primary bg-primary drop-shadow" : "border-gray-400 bg-white"}`}>
                        <svg className={`${optionsIndex === 1 ? "fill-white" : "fill-gray-400"}`} width="22" height="22" viewBox="0 0 32 32"><g>
                    ...
                    <span className={`pt-1 text-xs ${optionsIndex === 1 ? "text-primary font-semibold" : "text-gray-400 font-normal"}`}>Foto's</span>
                </div>
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(2)} className={`border-2 rounded-full p-3 ${optionsIndex === 2 ? "border-primary bg-primary drop-shadow" : "border-gray-400 bg-white"}`}>
                        <svg className={`${optionsIndex === 2 ? "fill-white" : "fill-gray-400"}`} width="22" height="22" viewBox="0 0 32 32"><g>
                    ...
                    <span className={`pt-1 text-xs ${optionsIndex === 2 ? "text-primary font-semibold" : "text-gray-400 font-normal"}`}>Links</span>
                </div>
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(3)} className={`border-2 rounded-full p-3 drop-shadow ${optionsIndex === 3 ? "border-primary bg-primary" : "border-gray-400 bg-white"}`}>
                        <svg className={`${optionsIndex === 3 ? "fill-white" : "fill-gray-400"}`} width="22" height="22" viewBox="0 0 32 32"><g>
                    ...
                    <span className={`pt-1 text-xs ${optionsIndex === 3 ? "text-primary font-semibold" : "text-gray-400 font-normal"}`}>Other</span>
                </div>
            </div>
