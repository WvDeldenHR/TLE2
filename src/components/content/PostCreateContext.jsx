    ...
    return (
        <>
            <div className="flex justify-center gap-4 border-b-2 border-gray-300 pt-10 pb-6">
                <button className={`rounded-lg w-30 h-8 text-xs text-white font-semibold bg-primary drop-shadow`}>Hulp Nodig</button>
                <button className={`border-2 border-gray-400 rounded-lg w-30 h-8 text-xs text-gray-400 font-semibold`}>Hulp Aanbieden</button>
            </div>

            <div className="flex justify-center gap-4 py-6">
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(0)} className={`border-2 rounded-full p-3 ${optionsIndex === 0 ? "border-primary bg-primary drop-shadow" : "border-gray-400"}`}>
                ...
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(1)} className={`border-2 rounded-full p-3 ${optionsIndex === 1 ? "border-primary bg-primary drop-shadow" : "border-gray-400"}`}>
                ...
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(2)} className={`border-2 rounded-full p-3 ${optionsIndex === 2 ? "border-primary bg-primary drop-shadow" : "border-gray-400"}`}>
                ...
                <div className="flex flex-col items-center">
                    <button onClick={() => optionsToggle(3)} className={`border-2 rounded-full p-3 ${optionsIndex === 3 ? "border-primary bg-primary drop-shadow" : "border-gray-400"}`}>
