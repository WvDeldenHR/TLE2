...
export function CreatePostText() {
    return (
        <div className="px-8">
        <div className="flex justify-center gap-4 border-b-2 border-gray-200 pt-10 pb-6">
            <button className="rounded-lg w-30 h-8 text-white text-xs font-semibold bg-primary drop-shadow">Hulp Nodig</button>
            <button className="border-2 border-gray-400 rounded-lg w-30 h-8 text-xs text-gray-400 font-semibold bg-white">Hulp Aanbieden</button>
        </div>

        <div className="flex justify-center gap-4 py-6">
            <div className="flex flex-col items-center">
                <button className="rounded-full p-3 bg-primary drop-shadow">
            ...
            <div className="flex flex-col items-center">
                <button className="border-gray-400 border-2 rounded-full p-3">
        ...
        <div className="flex items-center justify-center py-8">
            <button className="flex items-center rounded-xl px-6 py-2 bg-primary text-white font-semibold drop-shadow">Volgende
                <img className="ml-4 w-3" src={IconArrow} alt=""></img>
            </button>
        </div>
    </div>
    )
