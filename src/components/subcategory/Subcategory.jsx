...
const Subcategory = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const q = query(collection(db, 'posts'), where('subCategories', 'array-contains', subcategory));
  ...
  return (
    ...
    <h1 className='text-sm'>Zoekresultaten met de subcategorie</h1>
    <h2 className='text-primary text-xl font-bold'>{subcategory}</h2>
    </div>
